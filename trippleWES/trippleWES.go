...
func encrypt(plaintext, key uint8) (uint8) {
    return sbox[plaintext] ^ key
}

func decrypt(ciphertext, key uint8) (uint8) {
...
func SeptupleDecrypt(ciphertext, key3, key4, key5, key6, key7, key8, key9 uint8) (uint8) {
    ciphertext ^= key9
    ciphertext = sboxInv[ciphertext] ^ key8
    ciphertext = sboxInv[ciphertext] ^ key7
    ciphertext = sboxInv[ciphertext] ^ key6
...
func HextupleDecrypt(ciphertext, key4, key5, key6, key7, key8, key9 uint8) (uint8) {
    ciphertext ^= key9
    ciphertext = sboxInv[ciphertext] ^ key8
    ciphertext = sboxInv[ciphertext] ^ key7
    ciphertext = sboxInv[ciphertext] ^ key6
...
*/
func QuadruppleEncrypt(plaintext, key0, key1, key2, key3 uint8) (uint8) {
    plaintext ^= key0
    plaintext = sbox[plaintext] ^ key1
    plaintext = sbox[plaintext] ^ key2
    plaintext = sbox[plaintext] ^ key3
...
func TrippleEncrypt(plaintext, key0, key1, key2 uint8) (uint8) {
    plaintext ^= key0
    plaintext = sbox[plaintext] ^ key1
    plaintext = sbox[plaintext] ^ key2
